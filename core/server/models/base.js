...
ghostBookshelf.Model = ghostBookshelf.Model.extend({
    ...
    generateSlug: function (Model, base, readOptions) {
        ...
        slug = new RegExp("^(" + config().adminRoot.replace(/\//, "") + "|ghost|ghost\\-admin|admin|wp\\-admin|wp\\-login|dashboard|logout|login|signin|signup|signout|register|archive|archives|category|categories|tag|tags|page|pages|post|posts|user|users)$", "g")
